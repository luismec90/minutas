...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="http://static.livedemo00.template-help.com/wt_51138/css/bootstrap.css" >
    <link rel="stylesheet" href="http://static.livedemo00.template-help.com/wt_51138/css/style.css">
    <link rel="stylesheet" href="http://static.livedemo00.template-help.com/wt_51138/css/animate.css">
    <link rel="stylesheet" href="fonts/font-awesome.css">
    <!--JS-->
    <script src="http://static.livedemo00.template-help.com/wt_51138/js/jquery.js"></script>
    <script src="http://static.livedemo00.template-help.com/wt_51138/js/jquery-migrate-1.2.1.min.js"></script>
    <script src="http://static.livedemo00.template-help.com/wt_51138/js/superfish.js"></script>
    <script src="http://static.livedemo00.template-help.com/wt_51138/js/jquery.easing.1.3.js"></script>
    <script src="http://static.livedemo00.template-help.com/wt_51138/js/jquery.mobilemenu.js"></script>
    <script src="http://static.livedemo00.template-help.com/wt_51138/js/jquery.ui.totop.js"></script>
    <script src="http://static.livedemo00.template-help.com/wt_51138/js/jquery.equalheights.js"></script>
    <script src="http://static.livedemo00.template-help.com/wt_51138/js/sForm.js"></script>

    <script src="http://static.livedemo00.template-help.com/wt_51138/js/wow/wow.js"></script>
    <script src="http://static.livedemo00.template-help.com/wt_51138/js/wow/device.min.js"></script>
    <script>
...
<div class="bg_pic">
    <div class="container">
        <p class="title wow fadeInDown" data-wow-delay="0.2s">PREPARING STUDENTS FOR SUCCESSFUL <br>FUTURE!</p>
        <p class="description wow fadeInUp"><i></i>Lorem ipsum dolor sit amet, consectetur ipiscing elit<em></em></p>
    </div>
</div>
<div class="global">
    <!--content-->
...
<footer>
    <div class="container">
        <p>High School &copy; <em id="copyright-year"></em> <span>|</span> <a href="index-5.html">Privacy policy</a></p>
        <p class="foo_address">28 jackson blvd ste 1020<br>chicago, il 60604-2340</p>
    </div>
    <!-- {%FOOTER_LINK} -->
</footer>
<script src="http://static.livedemo00.template-help.com/wt_51138/js/bootstrap.min.js"></script>
<script src="http://static.livedemo00.template-help.com/wt_51138/js/tm-scripts.js"></script>
</body>
</html>